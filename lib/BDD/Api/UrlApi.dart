class UrlApi {
  ...
  static const teachers = "$hostUrl/all";
  static const courses = "$hostUrl/courses/all";
  static const coursesub = "$hostUrl/courses/subcategorie/";

  static const sessions = "$hostUrl/sessions";
  static const perPage1 = "$hostUrl/courses?perPage=1";
